...
gammas=(0.9)
gamma_names=(09)
effect_sizes=("small" "moderate" "large") 
...
#SBATCH --job-name=real_${effect_size}_${type_est}
#SBATCH --time=${time}
...
python3 02_evaluate_real.py \$SLURM_ARRAY_TASK_ID ${effect_size} ${type_est}" > 02_evaluate_${effect_size}_${type_est}_run.slurm
	 sbatch 02_evaluate_${effect_size}_${type_est}_run.slurm
